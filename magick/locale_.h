...
extern MagickExport double
  InterpretLocaleValue(const char *restricted,char **restrict);
...
extern MagickExport ssize_t
  FormatLocaleFile(FILE *,const char *restricted,...)
    magick_attribute((format (printf,2,3))),
  FormatLocaleFileList(FILE *,const char *restricted,va_list)
    magick_attribute((format (printf,2,0))),
  FormatLocaleString(char *restrict,const size_t,const char *restricted,...)
    magick_attribute((format (printf,3,4))),
  FormatLocaleStringList(char *restrict,const size_t,const char *restricted,
